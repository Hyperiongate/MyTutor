...
On Jim's disk: **`2026-09-26yh-the-fourth-precalc-sweep`** (battery 13,156 passed, 0
failed, 3 skipped) — Pre-Calc's fourth reading, 15 findings (28 at `xm`), 25 clean, all
...
1. The chain through `yh` is on D:\MyTutor; Jim pushes once, confirms
   `/health` shows `2026-09-26yh-the-fourth-precalc-sweep`, prewarms yh's ~11, yf's ~22 and
