...
- `screencheck.py` (`--script rota`, `--rota-size`, `--rota-day`, `--fail-on`; `rota_lessons`,
  ...
  `changelog/Build_ye_The_Scripted_Lane_Goes_Nightly_2026-09-25.md`, this handoff
  (`START_HERE_Handoff_2026-09-25.md`). Nothing to prewarm. After the push, the next 09:30 UTC
